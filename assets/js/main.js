...
document.querySelectorAll(".expand-button button").forEach((button) => {
  button.addEventListener("click", function () {
    const panel = this.parentElement.nextElementSibling;
    const isCollapsed = this.getAttribute("data-state") === "collapsed";

    // Toggle the 'active' class on the expandable panel
    panel.classList.toggle("active");

    // Update the button text and icon based on the state
    if (isCollapsed) {
      this.innerHTML =
        '<span><i class="fa-solid fa-dot-circle"></i> Close</span> <span><i class="fa-solid fa-minus"></i></span>';
      this.setAttribute("data-state", "expanded");
    } else {
      this.innerHTML =
        '<span><i class="fa-solid fa-dot-circle"></i> Read More</span> <span><i class="fa-solid fa-plus"></i></span>';
